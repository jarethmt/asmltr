...
// or ASMLTR_NODE — system node may be too old), grok CLI on PATH, ~/.grok/auth.json.
// Bind 127.0.0.1. Do NOT start the connector manager for a localhost-only assistant.
