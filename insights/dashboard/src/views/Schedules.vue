      ...
      <form class="flex flex-col gap-4" @submit.prevent="onSubmit">
        ...
        <template v-else>
          <div>
            ...
            <input v-model="form.command" type="text" class="field-input font-mono" placeholder="/path/to/notify-script 'Good morning'" />
          </div>
          <div>
            <label class="mb-1 block text-sm font-medium text-slate-200">…or script path</label>
            <input v-model="form.script_path" type="text" class="field-input font-mono" placeholder="/path/to/scripts/morning.py" />
          </div>
          <div class="grid grid-cols-1 gap-3 sm:grid-cols-2">
            <div>
