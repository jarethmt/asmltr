...
{ "channel": "discord",            // connector TYPE; first enabled instance of it is used
  ...
  "path": "~/report.pdf",      // for kind:"file" — absolute path on the host
...
asmltr send discord 123456789 --file ~/report.pdf --caption "the report"
```
...
Agent:
  1. Bash: asmltr send discord <reports-channel-id> --file ~/report.pdf --caption "monthly report"
